"""Filtro: Shares Outstanding - Evalua si las acciones en circulacion estan en rango."""
...
class FiltroSharesOutstanding(BaseFiltro):

    def evaluar(self, candles: list[Candle], filtro: Filtro, datos_fundamentales: DatosFundamentales | None = None) -> bool:
        if not datos_fundamentales or datos_fundamentales.shares_outstanding == 0:
