...
def test_regular_close_time():
    assert market_close_time(date(2026, 7, 16)) == time(16, 0, 0)


def test_early_close_july_3():
    assert market_close_time(date(2026, 7, 3)) == time(13, 0, 0)


def test_early_close_nov_27():
    assert market_close_time(date(2026, 11, 27)) == time(13, 0, 0)
...
def test_effective_end_capped_by_market_close():
    result = effective_end(time(20, 0, 0), date(2026, 7, 16))
    assert result == time(16, 0, 0)


def test_effective_end_capped_by_early_close():
    result = effective_end(time(20, 0, 0), date(2026, 7, 3))
    assert result == time(13, 0, 0)
